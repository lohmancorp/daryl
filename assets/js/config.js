...
const analysisObjectiveInput = document.getElementById('analysisObjectiveInput');
const wysiwygToolbar = document.getElementById('wysiwyg-toolbar');
const generatePromptBtn = document.getElementById('generatePromptBtn');
const promptContentContainer = document.getElementById('promptContentContainer');
const promptGenerationSpinner = document.getElementById('promptGenerationSpinner');
